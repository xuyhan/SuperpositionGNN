...
NUM_WORKERS=8
SEED_START=101
SEED_STOP=401        # exclusive, to mirror Python's range()
...
PY_ARGS_BASE=( -m src.experiment_topology --seed-start "$SEED_START" --seed-stop "$SEED_STOP" --group-size "$GROUP_SIZE" )
